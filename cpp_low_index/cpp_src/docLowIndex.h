...
R"doc(Given a finitely presented group of with rank generators and relators
short_relators and long_relators return a permutation representation
for each subgroup of index up to max_degree.

thread_num = 0 means that the number of cores will be used as number
of threads.)doc";
